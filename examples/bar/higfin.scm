...
(ng #t)
(use "NatLeCases" (pt "Succ Lh vss") (pt "i"))
(use "i<=Succ Lh vss")
...
(assume "ws" "vss" "IH" "ws0" "i" "j" "i<=Succ Lh vss" "j<=Succ Lh vss"
	"i=j -> F")
(ng #t)
(use "NatLeCases" (pt "Succ Lh vss") (pt "j"))
(use "j<=Succ Lh vss")
...
(simp "nDef")
(ng)
(use "NatLtSuccCases" (pt "Lh vss") (pt "i"))
(use "i<SLhvss")
(assume "Hyp")
(use "Hyp")
(assume "i=Lh vss")
